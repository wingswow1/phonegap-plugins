...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 480)])
    {
        ...
        [cancelButton addTarget:self action:@selector(cancelPannel) forControlEvents:UIControlEventTouchUpInside];
        cancelButton.frame=CGRectMake(270, 0, 30, 30);
        [cancelButton setBackgroundImage:[UIImage imageNamed:@"cancelBtn.png"] forState:UIControlStateNormal];
