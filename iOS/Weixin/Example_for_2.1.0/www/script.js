...
function sendMusicContent(){
    plugins.weixin.musicContent(onSuccess,onError,"send",
                                 "http://mocodo.sinaapp.com/Media/music/Sunshine.mp3",
                                 {
                                 title:"Sunshine",
                                 description:"Happy Music",
                                 thumbUrl:"http://tp2.sinaimg.cn/1225910413/180/5610285473/0",
                                 scene:sendType
                                 });
}
...
function sendWebpageContent(){
    plugins.weixin.webpageContent(onSuccess,onError,"send",
                                   ...
                                   thumbUrl:"http://sae.sina.com.cn/static/image/bottom_logo2.png",
                                   scene:sendType
                                   });
}
